(function () {
  ...
  window.BankWorkspace.init({
    ...
    nav: [
      ...
      { id:'accounts', label:'All accounts', shortLabel:'Accounts', icon:'card', group:'Enterprise operations', title:'All bank accounts', description:'Read account information and history across every branch.' },
