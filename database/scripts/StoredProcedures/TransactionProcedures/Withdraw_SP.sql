/* =========================================================
   ...
   ---------------------------------------------------------
   FINAL AUTHORIZATION:
   - Customer can withdraw only from own account.
   - Effective Employee/Admin/HighAdmin can withdraw from any account.
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN RAISERROR('Customer users can withdraw only from their own accounts.', 16, 1); RETURN; END;
